...
export const Navbar = () => {
    const salas = [
        { title: 'Sala 1', links: [{ to: 'sala/6617f798c3eb3b3b51f8df76/pregunta/6617f799c3eb3b3b51f8df78', label: 'Pregunta 1' }, { to: '/resultado/sala/6617f798c3eb3b3b51f8df76/pregunta/6617f799c3eb3b3b51f8df78', label: 'Resultado 1' },{ to: '/sala1_qr1', label: 'QR pregunta 1' },  { to: 'sala/6617f798c3eb3b3b51f8df76/pregunta/66244bb203d88da06a04ae8b', label: 'Pregunta 2' }, { to: '/resultado/sala/6617f798c3eb3b3b51f8df76/pregunta/66244bb203d88da06a04ae8b', label: 'Resultado 2' }, { to: '/sala1_qr2', label: 'QR pregunta 2' }] },
